...
class Gain:
  ...
  def __init__(self, text):
    ...
    elif self.device in ("main-mic", "second-mic", "headset-mic", "bt-sco-hs-mic"):
...
print """<mixer>
"""
print "  <!-- file automatically generated by tinyucm2mixerpaths.py (C) 2015 Schischu -->"
...
print findGain(gains, "bt-sco-hs-mic", "voicecall").toMixerPaths()
...
print findGain(gains, "bt-sco-hs-mic", "voicecall").toMixerPaths(om="voice")
